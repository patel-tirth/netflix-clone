...
class EntityProvider{
    ...
    public function getTvShowEntities($con, $categoryId, $limit){
    ...
    public function getMoviesEntities($con, $categoryId, $limit){
    ...
    public function getSearchEntities($con, $term){
